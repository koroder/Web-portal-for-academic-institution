...
<body>
<p align="center" class="style7">PLEASE ENTER THE DETAILS</p>
<form id="form1" name="form1" method="post" action="req.php">
  ...
  <span class="selectRequiredMsg">Please select an it</span></span><span class="style3 style6">end time should be greater than start time</span></p>
  ...
  <p align="center"><span class="style5"><span class="style6">six character password for this request</span>
